 ...
 * Based on spicy-card's LegacySpring.ts
 * Used for smooth, physics-based animations (bounce, y-offset, glow)
 */
...
export class Spring {
	...
	public Update(deltaTime: number): number {
		...
		let newPosition: number, newVelocity: number
